...
2. **Inspect a district** through score chips, a profile card, a polygon map, and compact signal bars.
...
> Indre By appears as a top match with visible mood pills, score bars, and a short explanation that separates strengths from tradeoffs.
...
The scores are **explainable comparison scores**, not official statistics. They are designed for exploration and comparison, not for absolute claims about neighbourhood quality, safety, or desirability.
...
- Scores are comparison scores, not official rankings.
...
- International Feel uses citizenship based demographic signals, daily services and culture.
